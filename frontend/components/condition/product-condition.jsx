...
import { ProductPicker, CollectionPicker, TagPicker } from "@/components/picker";
	...
	const handleAttributeChange = useCallback(
		async function (attributeName, attributeValue) {
			...
			if (attributeName === "productIds") {
				...
				const response = await requestHelper.get("/products", queryStrings);
				...
				const queryStrings = attributeValue.map((id) => "id:" + id);
				const response = await requestHelper.get("/collections", queryStrings);
